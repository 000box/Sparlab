            ...
            for event_kind, handlers in evt_handlers[key].items():
                ...
                for function_handler in handlers:
                    ...
                    if handlers[function_handler]:
                        # print("function handler func 1. fh: {}".format(function_handler))
                        function_handler(new_value,
                                event_kind, handlers[function_handler])
                    else:
                        # print("function handler func 2. fh: {}".format(function_handler))
                        # res = time.time() - begin
                        # print("function_handler call took {} seconds".format(res))
