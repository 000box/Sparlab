...
class GUI_FrameDataOverlay(GUI_Overlay.Overlay):
    def __init__(self, master, launcher, pos):
        ...
        GUI_Overlay.Overlay.__init__(self, master, pos, "Tekken Bot: Frame Data Overlay")
        ...
        self.redirector1 = TextRedirector(self.stdout, self.text, self.s, self.fa_p1_var, self.fa_p2_var)
        ...
        self.redirector1.set_columns_to_print(self.get_data_columns())
    ...
    def create_live_recovery(self, parent, col):
        ...
        lrbtn = Button(parent, text='live recovery!', command=lambda: print("hello fockers"))
        lrbtn.place(rely=0.0, relx=0.0, x=4, y=20, anchor=NW)
